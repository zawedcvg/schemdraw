...
class AudioJack(Element):
    ...
    _element_defaults = {"radius": 0.075, "open": True}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if ring:
            if dots:
                self.segments.append(
                    SegmentCircle((0, -sleevey), r, fill=fill, zorder=4)
                )
            self.segments.append(
                Segment(
                    [
            ...
            if dots:
                self.segments.append(SegmentCircle((0, ringy), r, fill=fill, zorder=4))
            self.segments.append(
                Segment(
                    [
                        (-r, ringy),
            ...
            if dots:
                self.segments.append(SegmentCircle((0, 0), r, fill=fill, zorder=4))
            self.segments.append(
                Segment(
                    [
                        (-r, 0),
        ...
        if dots:
            self.segments.append(SegmentCircle((0, tipy), r, fill=fill, zorder=4))
        self.segments.append(
            Segment(
                [
                    (-r, tipy),
        ...
        if switch:
            if dots:
                self.segments.append(
                    SegmentCircle((0, tipy - swdy), r, fill=fill, zorder=4)
                )
        ...
        if ring and ringswitch:
            if dots:
                self.segments.append(
                    SegmentCircle((0, ringy + swdy), r, fill=fill, zorder=4)
                )
