...
class ElementTwoport(ElementCompound):
    ...
    def __init__(
        self,
        input_element: type[elm.Element2Term],
        ...
        boxlw: Optional[float] = None,
        boxls: Optional[Linestyle] = None,
        **kwargs,
    ):
    ...
    def setup(self):
        ...
        if self.box:
            self.add(
                elm.Rect(
                    theta=0,
                    at=[0, 0],
                    corner1=(0, bbox.ymin - self.boxpady),
                    corner2=(self.width, bbox.ymax + self.boxpady),
                    fill=self.boxfill,
                    lw=self.boxlw,
                    ls=self.boxls,
                    zorder=0,
        ...
        out_p = self.add(
            elm.Line().at(self.output_component.start).tox(bbox.xmax).right()
        )
        out_n = self.add(
            elm.Line().at(self.output_component.end).tox(bbox.xmax).right()
        )
...
class TwoPort(ElementTwoport):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            input_element=elm.Gap,
            output_element=elm.Gap,
            boxpadx=0,
            minw=0,
            component_offset=2,
            **kwargs,
    ...
    def setup(self):
        ...
        if self.sign:
            ...
            self.segments.append(
                SegmentText(
                    pos=Point((0.1, 0.1)) + self.input_component.end,
                    label="−",
                    align=("left", "center"),
            ...
            self.segments.append(
                SegmentText(
                    pos=Point((0.1, -0.1)) + self.input_component.start,
                    label="+",
                    align=("left", "center"),
                    rotation_global=False,
                )
            ...
            if not self.reverse_output:
                self.segments.append(
                    SegmentText(
                        pos=Point((-0.1, 0.1)) + self.output_component.end,
                        label="−",
                        align=("right", "center"),
                        rotation_global=False,
                    )
                ...
                self.segments.append(
                    SegmentText(
                        pos=Point((-0.1, -0.1)) + self.output_component.start,
                        label="+",
                        align=("right", "center"),
                        rotation_global=False,
                    )
        ...
        if self.arrow:
            ...
            self.segments.append(
                Segment(
                    (
                        center_point + Point((-tp_arrowlen / 2, 0)),
                        center_point + Point((tp_arrowlen / 2, 0)),
                    ),
                    arrow="->",
                    lw=2,
...
class VoltageTransactor(ElementTwoport):
    ...
    def setup(self):
        ...
        self.segments.append(
            SegmentText(
                pos=Point((0, 0.05)) + self.input_component.end,
                label="−",
                align=("right", "bottom"),
                rotation_global=False,
            )
        ...
        self.segments.append(
            SegmentText(
                pos=Point((0, -0.05)) + self.input_component.start,
                label="+",
                align=("right", "top"),
                rotation_global=False,
            )
...
class TransimpedanceTransactor(ElementTwoport):
    ...
    def __init__(self, reverse_output: bool = False, **kwargs):
        ...
        if not reverse_output:
            ...
            output_element = partial(output_element, reverse=True)  # type:ignore
        super().__init__(
            input_element=elm.Line, output_element=output_element, **kwargs
        )
...
class Nullor(ElementTwoport):
    ...
    def __init__(self, **kwargs):
        super().__init__(
            input_element=elm.Nullator,
            output_element=elm.Norator,
            boxpadx=0.3,
            **kwargs,
        )
...
class VMCMPair(ElementTwoport):
    ...
    def __init__(self, **kwargs):
        super().__init__(
            input_element=elm.VoltageMirror,
            output_element=elm.CurrentMirror,
            boxpadx=0.3,
            **kwargs,
        )
