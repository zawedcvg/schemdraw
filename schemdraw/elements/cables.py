    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.segments.append(
            Segment(  # Center conductor
                [
                    (0, 0),
                    (_leadlen, 0),
                    gap,
                    (_length - _leadlen + _radius / 2, 0),
                    (_length, 0),
                ]
            )
        )
        self.segments.append(
            Segment([(_leadlen, _radius), (_length - _leadlen, _radius)])
        )  # Top
        self.segments.append(
            Segment([(_leadlen, -_radius), (_length - _leadlen, -_radius)])
        )  # Bottom
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if _length - _leadlen - _shieldofstend + r2 < _length:
            ...
            self.segments.append(
                Segment(  # Center conductor (first)
                    [
                        (0, 0),
                        (_leadlen, 0),
                        gap,
        ...
        self.segments.append(
            Segment(  # guard (inner) top/left
                [(_leadlen, r1), (_leadlen + _shieldofststart + xshield, r1)]
            )
        )
        self.segments.append(
            Segment(  # guard (inner) bottom/left
                [(_leadlen, -r1), (_leadlen + _shieldofststart + xshield, -r1)]
            )
        )
        self.segments.append(
            Segment(  # shield (outer) top
                [
        ...
        self.segments.append(
            SegmentArc((_leadlen, 0), width=r1, height=r1 * 2, theta1=0, theta2=360)
        )
        self.segments.append(
            SegmentArc(
                (_leadlen + _shieldofststart, 0),
                width=r2,
                height=r2 * 2,
                theta1=-thetashield,
                theta2=thetashield,
        ...
        self.segments.append(
            SegmentArc(
                (_length - _leadlen - _shieldofstend, 0),
                width=r2,
                height=r2 * 2,
                theta1=270,
                theta2=90,
