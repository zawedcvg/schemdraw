...
class NMos(_Mosfet):
    ...
    def __init__(
        self, diode: Optional[bool] = False, circle: Optional[bool] = False, **kwargs
    ):
...
class _Mosfet2(Element2Term):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.params["circle"]:
            self.segments.append(SegmentCircle((10 * u, -1 * u), 7 * u))
...
class NFet(Element):
    ...
    def __init__(self, *, bulk: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment([(fetw + fetgap, -fetl), (fetw + fetgap, -fetl - fetw)])
        )
        self.segments.append(
            Segment(
                [
                    (fetw + fetgap, -fetl - fetw / 2),
        ...
        if self.params["bulk"]:
            self.segments.append(
                Segment(
                    [(0, -fetl - fetw / 2), (fetw, -fetl - fetw / 2)],
                    arrow="->",
                    arrowwidth=0.2,
                )
            )
...
class PFet(Element):
    ...
    def __init__(self, *, bulk: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [
                    (fetw + fetgap + fetr * 2, -fetl - fetw / 2),
                    (fetw + fetgap + fetl + fetr, -fetl - fetw / 2),
                ]
            )
        )
        self.segments.append(
            SegmentCircle((fetw + fetgap + fetr, -fetl - fetw / 2), fetr)
        )
...
class NFet2(Element2Term):
    ...
    def __init__(self, *, bulk: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment([(fetl, fetw + fetgap), (fetl + fetw, fetw + fetgap)])
        )
        self.segments.append(
            Segment(
                [
                    (fetl + fetw / 2, fetw + fetgap),
                    (fetl + fetw / 2, fetw + fetgap + fetr + fetl),
                ]
            )
        )
        ...
        if self.params["bulk"]:
            self.segments.append(
                Segment(
                    [(fetl + fetw / 2, 0), (fetl + fetw / 2, fetw)],
                    arrow="->",
                    arrowwidth=0.2,
                )
            )
...
class PFet2(Element2Term):
    ...
    def __init__(self, *, bulk: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            SegmentCircle((fetl + fetw / 2, fetw + fetgap + fetr), fetr)
        )
        self.segments.append(
            Segment(
                [
                    (fetl + fetw / 2, fetw + fetgap + fetr * 2),
                    (fetl + fetw / 2, fetw + fetgap + fetr + fetl),
                ]
            )
        )
...
class _AnalogFet(Element):
    _element_defaults = {"bulk": False, "offset_gate": True, "arrow": True}
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.params["bulk"]:
            self.segments.append(
                Segment(
                    [(0, -afetl - afeth / 2), (afetw, -afetl - afeth / 2)],
                    arrow="->",
                    arrowwidth=afeta,
                    arrowlength=afeta,
                )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.params["bulk"]:
            self.segments.append(
                Segment(
                    [(afetw, -afetl - afeth / 2), (0, -afetl - afeth / 2)],
                    arrow="->",
                    arrowwidth=afeta,
                    arrowlength=afeta,
                )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if _arrow:
            self.segments.append(
                SegmentCircle(
                    center=(afetb * 2, -afetl - afeth), radius=afetb, fill=True
                )
            )
        self.segments.append(
            Segment(
        ...
        if self.params["bulk"]:
            self.segments.append(
                Segment([(0, -afetl - afeth / 2), (afetw, -afetl - afeth / 2)])
            )
            self.segments.append(
                SegmentCircle(
                    center=(afetw - afetb * 2, -afetl - afeth / 2),
                    radius=afetb,
                    fill=True,
                )
            )
...
class JFet(Element):
    ...
    _element_defaults = {"circle": False, "lblloc": "lft"}
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment([(jfetw, -fetl - jfetw), (jfetw + fetl, -fetl - jfetw)])
        )
...
class JFetN(JFet):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(jfetw + 0.1, -fetl - jfetw), (jfetw + 0.3, -fetl - jfetw)],
                arrow="->",
                arrowwidth=0.2,
                arrowlength=0.2,
            )
...
class JFet2(Element2Term):
    ...
    _element_defaults = {"circle": False, "lblloc": "bottom"}
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment([(fetl - fete, jfetw), (fetl + jfetw + fete, jfetw)])
        )
        self.segments.append(
            Segment([(fetl + jfetw, jfetw), (fetl + jfetw, jfetw + fetl)])
        )
        ...
        if self.params["circle"]:
            self.segments.append(
                SegmentCircle((fetl + jfetw / 2, jfetw / 2), fetw * 1.1)
            )
...
class JFetN2(JFet2):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(fetl + jfetw, jfetw), (fetl + jfetw, jfetw + 0.3)],
                arrow="->",
                arrowwidth=0.2,
                arrowlength=0.2,
            )
...
class JFetP2(JFet2):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(fetl + jfetw, jfetw + 0.3), (fetl + jfetw, jfetw)],
                arrow="->",
                arrowwidth=0.2,
                arrowlength=0.2,
            )
...
class JFetP(JFet):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(jfetw + 0.25, -fetl - jfetw), (jfetw, -fetl - jfetw)],
                arrow="->",
                arrowwidth=0.2,
                arrowlength=0.2,
            )
...
bjt_emx = bjt_v + bjt_r * 0.7  # x-coord of emitter exiting circle
bjt_emy = bjt_v_len * 0.7  # y-coord of emitter exiting circle
...
class Bjt(Element):
    ...
    _element_defaults = {"circle": False, "lblloc": "rgt"}
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment([(bjt_v, bjt_a), (bjt_emx, bjt_emy), (bjt_emx, bjt_emy + bjt_a)])
        )
        self.segments.append(
            Segment([(bjt_v, -bjt_a), (bjt_emx, -bjt_emy), (bjt_emx, -bjt_emy - bjt_a)])
        )
...
class BjtNpn(Bjt):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        super().__init__(circle=circle, **kwargs)
        self.segments.append(
            Segment([(bjt_v, -bjt_a), (bjt_emx, -bjt_emy)], arrow="->", arrowwidth=0.2)
        )
...
class BjtPnp(Bjt):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        super().__init__(circle=circle, **kwargs)
        self.segments.append(
            Segment([(bjt_emx, bjt_emy), (bjt_v, bjt_a)], arrow="->", arrowwidth=0.2)
        )
        self.anchors["base"] = (0, 0)
        self.anchors["collector"] = (bjt_emx, -bjt_emy - bjt_a)
        self.anchors["emitter"] = (bjt_emx, bjt_emy + bjt_a)
...
class BjtPnp2c(BjtPnp):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        bjt_2c_dy = -0.25
        self.segments.append(
            Segment([(bjt_v, -bjt_a - bjt_2c_dy), (bjt_emx, -bjt_emy - bjt_2c_dy)])
        )
        self.anchors["C2"] = (bjt_emx, -bjt_emy - bjt_2c_dy)
        self.C2: Point


bjt_r = 0.55  # BJT circle radius
bjt_lead_dflt = 0.18  # Default lead length
bjt_diag_ofst = 0.2  # Distance from base to diagonals
bjt_base_w = 0.75  # Length of base bar
bjt_base_h = 0.42  # Height of base bar above leads
...
class BjtNpn2(Bjt2):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(0, 0), (bjt_width / 2 - bjt_diag_ofst, bjt_base_h)],
                arrow="<-",
                arrowwidth=0.2,
            )
        )
...
class BjtPnp2(Bjt2):
    ...
    def __init__(self, *, circle: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [(bjt_width / 2 + bjt_diag_ofst, bjt_base_h), (bjt_width, 0)],
                arrow="<-",
                arrowwidth=0.2,
            )
        )
        self.anchors["icollector"], self.anchors["iemitter"] = (
            self.anchors["iemitter"],
            self.anchors["icollector"],
        )
