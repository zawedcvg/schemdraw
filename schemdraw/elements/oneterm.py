...
class Ground(Element):
    ...
    _element_defaults = {"lead": True, "theta": 0, "drop": (0, 0)}

    def __init__(self, *, lead: Optional[bool] = None, **kwargs):
        ...
        self.segments.append(
            Segment(
                [
                    ...
                    (resheight, -gnd_lead),
                    gap,
                    (-resheight * 0.7, -gndgap - gnd_lead),
                    (resheight * 0.7, -gndgap - gnd_lead),
                    gap,
                    (-resheight * 0.2, -gndgap * 2 - gnd_lead),
                    (resheight * 0.2, -gndgap * 2 - gnd_lead),
                ]
            )
        )
...
class GroundSignal(Element):
    ...
    def __init__(self, *, lead: bool = True, **kwargs):
        super().__init__(**kwargs)
        gnd_lead = _gnd_lead if self.params["lead"] else 0
        self.segments.append(
            Segment(
...
class GroundChassis(Element):
    ...
    _element_defaults = {"lead": True, "drop": (0, 0), "theta": 0}
    ...
    def __init__(self, **kwargs):
        ...
        self.segments.append(
            Segment([(0, -gnd_lead), (-dx, -gnd_lead), (-dx * 2, -gnd_lead - dy)])
        )
        self.segments.append(
            Segment([(0, -gnd_lead), (dx, -gnd_lead), (0, -gnd_lead - dy)])
        )
...
class Antenna(Element):
    ...
    def __init__(self, **kwargs):
        ...
        w = 0.38
        self.segments.append(
            Segment([(0, 0), (0, lead), (-w, lead + h), (w, lead + h), (0, lead)])
        )
        self.elmparams["drop"] = (0, 0)
        self.elmparams["theta"] = 0
        self.anchors["start"] = (0, 0)
...
class Vss(Element):
    ...
    _element_defaults = {"lead": True, "drop": (0, 0), "theta": 0, "lblloc": "bottom"}
